    ...
    <div style="margin-left: 100px;" class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Responsable enquetes</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-9">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <h5 class="card-title">Listes des Responsables</h5>
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div style="background-color: #025ea7;" class="modal-header">
                            <h5 class="modal-title" style="color: white;">Nouvelle Responsable</h5>
                          ...
                          <form action="/AjouterUtilisateur" method="post">
                            <div class="modal-body">
                             ...
                             <select class="form-control" name="fonction" id="" >
                                  ...
                                  <%
                                     ArrayList<Fonction> fonctionInput= (ArrayList<Fonction>) session.getAttribute("fonctionInput");
                                      for(Fonction fp : fonctionInput){ 
                                  %>                                
                                  <option value=" <%= fp.getId() %>"><%= fp.getNom() %></option>
                                  <%}%>
                                </select>
                            </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-2">
                          <input class="btn btn-primary" style="margin-top: 0px;background-color: #025ea7;color: white;" type="submit" value="Rechercher">    
						            ...
						            listUtilisateur = (List<DetailUtilisateur>)session.getAttribute("listUtilisateur");  
                  ...
                  <table style="margin-top: 20px;" class="table table-borderless">
                    ...
                    <tbody>
                  		<%  for(DetailUtilisateur s : listUtilisateur){ %>
                      ...
                      <div class="modal fade" id="haha<%= s.getId()%>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <form action="/UpdateUtilisateur" method="post">
                              <div class="modal-body">
                                <label for="">Nom</label>
                                <input style="margin-top: 20px;" class="form-control" type="text" name="nom" value="<%= s.getNom() %>">
                                <input type="hidden" name="id" value="<%= s.getId() %>">
                                <label for="">Prenom</label>
                                <input style="margin-top: 20px;" class="form-control" type="text" name="prenom" placeholder="Prenom ..." value="<%= s.getPrenom() %>">
                                <label for="">Matricule</label>
                                <input style="margin-top: 20px;" class="form-control" type="text" name="matricule" placeholder="Matricule..." value="<%= s.getMatricule() %>">
                                <label for="">Mot de passe</label>
                                <input style="margin-top: 20px;" class="form-control" type="text" name="motdepasse" placeholder="Mot de Passe" value="<%= s.getMotedepasse() %>">
                                <label for="">Fonction</label>
                                <select class="form-control" name="fonction" id="" >
                                  <option value="<%= s.getIdfonction()%>"><%= s.getFonction() %></option>
                                  <%
                                    
                                      for(Fonction f : fonctionInput){ 
                                  %>                                
                      ...
                      <div class="modal fade" id="desactiver<%=s.getId() %>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                           ...
                           <form action="/DesactiveUtilisateur" method="get">
                            <div class="modal-body">
                    ...
                    <div class="modal fade" id="act<%=s.getId() %>" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                         ...
                         <form action="/ActiveUtilisateur" method="get">
                          <div class="modal-body">
