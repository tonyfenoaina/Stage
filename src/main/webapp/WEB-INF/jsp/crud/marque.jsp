            ...
            <div class="col-9">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <h5 class="card-title">Listes des Marques de Categorie : <%=session.getAttribute("nomCategorie")%></h5>
                  <div style="margin-top: 20px;" class="row">
                    
                  
                    <div style="margin-left: 20px ;" class="col-2">
                      <button  data-bs-toggle="modal" data-bs-target="#Marque" style="background-color: #025ea7;" type="button" class="btn btn-primary"><i class="bx bxs-plus-circle"></i> Ajouter</button>
                    </div>

                    <div class="modal fade" id="Marque" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div style="background-color: #025ea7;" class="modal-header">
                            <h5 class="modal-title" style="color: white;">Nouvelle Marques</h5>
                            
                          </div>
                          <form action="/AjouterMarque" method="post">
                            <div class="modal-body">
                              <label for="">Nom</label>
                              <input style="margin-top: 20px;" class="form-control" type="text" name="nom" placeholder="Nom de la nouvelle Marque">
                             
                              <label style="margin-top: 20px;"  for="">Societe</label>
                              <select style="margin-top: 20px;"  class="form-control" name="idsociete" id="">
                                <%
                                    List<Societe> listSocieteinput = new ArrayList<Societe>();
					
                                listSocieteinput = (List<Societe>)session.getAttribute("listsocieteinput");  
                                            for(Societe s : listSocieteinput){ 
                                %>
                    ...
                    <tbody>
                      ...
                      <div class="modal fade" id="haha<%= s.getId()%>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            <div style="background-color: #025ea7;" class="modal-header">
                              <h5 class="modal-title" style="color: white;">Modification de la Marque numero <%=s.getId() %></h5>
                            </div>
                            <form action="/UpdateMarque" method="post">
                              <div class="modal-body">
                                ...
                                <select style="margin-top: 20px;"  class="form-control" name="idsociete" id="">
                                  <option value="<%= s.getIdsociete() %>"><%= s.getSociete() %></option>
                                  <%
                                     
            
                                  listSocieteinput = (List<Societe>)session.getAttribute("listsocieteinput");  
                                              for(Societe so : listSocieteinput){ 
                                  %>
                                  <option value="<%= so.getId() %>"><%= so.getNom() %></option>
                                  <%}%>
                                </select>
                              </div>
                              <div class="modal-footer">
                      ...
                      <td> <a href="produit?id=<%= s.getId()%>&nom=<%= s.getNom()%>"><button style="background-color: #025ea7;" type="button" class="btn btn-primary">Produit<i class="ri-edit-2-fill"></i></button></a></td>
                      ...
                      <div class="modal fade" id="desactiver<%=s.getId() %>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                           ...
                           <form action="/DesactiveMarque" method="get">
                            <div class="modal-body">
                    ...
                    <div class="modal fade" id="act<%=s.getId() %>" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                         ...
                         <form action="/ActiveMarque" method="get">
                          <div class="modal-body">
