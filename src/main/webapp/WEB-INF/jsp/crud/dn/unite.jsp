...
<body>
  ...
  <main id="main" class="main">
    ...
    <div style="margin-left: 100px;" class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item ">Gestion des Fiche de Dn</li> 
            ...
            <div class="col-9">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <h5 class="card-title">Listes des Unites</h5>
                    ...
                    <div class="modal fade" id="ville" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="/AjouterUnite" method="post">
                  ...
                  <div class="col-5">
                    <form action="/RechercheUnite" method="post">
                      <div class="row">
                        <%
                        ...
                        <div class="col-2">
                          <input class="btn btn-primary" style="margin-top: 0px;background-color: #025ea7;color: white;" type="submit" value="Rechercher">    
						            ...
						            listUnite = (List<Unite>)session.getAttribute("listUnite");  
                      ...
                      <div class="modal fade" id="haha<%= s.getId()%>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <form action="/UpdateUnite" method="post">
                              <div class="modal-body">
                                <label for="">Nom</label>
                      ...
                      <div class="modal fade" id="desactiver<%=s.getId() %>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                           ...
                           <form action="/DesactiveUnite" method="get">
                            <div class="modal-body">
                    ...
                    <div class="modal fade" id="act<%=s.getId() %>" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                         ...
                         <form action="/ActiveUnite" method="get">
                          <div class="modal-body">
