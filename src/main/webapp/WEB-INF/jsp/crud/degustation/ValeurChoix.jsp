    ...
    <div style="margin-left: 100px;" class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">ValeurChoix</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <div class="col-9">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <h5 class="card-title">Listes des ValeurChoix</h5>
                  <div style="margin-top: 20px;" class="row">
                    
                  
                    <div style="margin-left: 20px ;" class="col-2">
                      <button data-bs-toggle="modal" data-bs-target="#ValeurChoix" style="background-color: #025ea7;" type="button" class="btn btn-primary"><i class="bx bxs-plus-circle"></i> Ajouter</button>
                    </div>

                    <div class="modal fade" id="ValeurChoix" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="/AjouterValeurChoix" method="post">
                  ...
                  <div class="col-5">
                    <form action="/RechercheValeurChoix" method="post">
                      <div class="row">
                        <%
                        ...
                        <div class="col-2">
                          <input class="btn btn-primary" style="margin-top: 0px;background-color: #025ea7;color: white;" type="submit" value="Rechercher">    
						            ...
						            listValeurChoix = (List<ValeurChoix>)session.getAttribute("listValeurChoix");  
                  ...
                  <table style="margin-top: 20px;" class="table table-borderless">
                    ...
                    <tbody>
                  		<%  for(ValeurChoix s : listValeurChoix){ %>
                      ...
                      <div class="modal fade" id="haha<%= s.getId()%>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            <div style="background-color: #025ea7;" class="modal-header">
                              <h5 class="modal-title" style="color: white;">Modification de la ValeurChoix numero <%=s.getId() %></h5>
                              
                            </div>
                            <form action="/UpdateValeurChoix" method="post">
                              <div class="modal-body">
                                <label for="">Nom</label>
                      ...
                      <div class="modal fade" id="desactiver<%=s.getId() %>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                           ...
                           <form action="/DesactiveValeurChoix" method="get">
                            <div class="modal-body">
                    ...
                    <div class="modal fade" id="act<%=s.getId() %>" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                         ...
                         <form action="/ActiveValeurChoix" method="get">
                          <div class="modal-body">
                  ...
                  <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                    <ul class="pagination">
                      ...
                      <li class="page-item active" aria-current="page">
                        <a style="background-color: #025ea7;" class="page-link" href="/pageValeurChoix?page=<%=current-1%>"><%=current%></a>
                      </li>
                    ...
                    %>
                    <li class="page-item"><a class="page-link" href="/pageValeurChoix?page=<%=current%>"><%=current+1%></a></li>
                    <li class="page-item disabled"><a class="page-link" href="/pageValeurChoix?page=<%=current+1%>" aria-disabled="true"><%=current+2%></a></li>
                    <li class="page-item">
                      <a class="page-link" href="/pageValeurChoix?page=<%=next%>">Suivant</a>
                    </li>
                    <%} else {%>

                      <li class="page-item"><a class="page-link" href="/pageValeurChoix?page=<%=current%>"><%=current+1%></a></li>
                      <li class="page-item"><a class="page-link" href="/pageValeurChoix?page=<%=current+1%>"><%=current+2%></a></li>
                      <li class="page-item">
                        <a class="page-link" href="/pageValeurChoix?page=<%=next%>">Next</a>
                      </li>
                  ...
                  <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                    <ul class="pagination">
                      <li class="page-item ">
                        <a class="page-link" href="/pageValeurChoix?page=<%=previous%>" tabindex="-1" >Precedent</a>
                      </li>
                    
                     
                      <li class="page-item"><a class="page-link" href="/pageValeurChoix?page=<%=current-2%>"><%=current-1%></a></li>
  
                      <li class="page-item active" aria-current="page">
                        <a style="background-color: #025ea7;" class="page-link" href="/pageValeurChoix?page=<%=current-1%>"><%=current%></a>
                      </li>

                      <li class="page-item disabled"><a class="page-link" href="/pageValeurChoix?page=<%=current%>" aria-disabled="true"><%=current+1%></a></li>
                ...
                <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                  <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="/pageValeurChoix?page=<%=current-3%>"><%=current-2%></a></li>
                ...
                <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                  <ul class="pagination">
                    ...
                    <li class="page-item disabled"><a class="page-link" href="/pageValeurChoix?page=<%=current%>" aria-disabled="true"><%=current+1%></a></li>
                    <li class="page-item disabled">
                      <a class="page-link" href="/pageValeurChoix?page=<%=next%>" aria-disabled="true">Suivant</a>
                    </li>
                    <%
                      }else{
                    %>
