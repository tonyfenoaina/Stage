                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <th></th>
                           ...
                           <th><form action="PageproduitDegustation" method="get">
                          ...
                          <th>
                            <form action="AjouterMarquedegustation" method="post">
            ...
            <div class="col-5">
              <div class="card top-selling overflow-auto">
                ...
                <div style="min-height: 600px; max-height: 600px;" class="card-body pb-0">
                  ...
                  %>
                  <div class="col-2"><a href="/detailquestion?iddegustation=<%=iddegustation%>"><button type="submit" style="background-color: #025ea7;" class="btn btn-primary">Question</button></a></div>
                </div>
                       ...
                       %>
                          <tr style="margin-top: 30px;">
                            ...
                            <%if (d.getProduit()!= null){
                              ...
                              <%}%>
                            <th>
                              <form action="/DeleteMarquedegustation" method="get">
