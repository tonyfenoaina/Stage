              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <div style="margin-top: 20px;" class="row">
                    ...
                    <div class="modal fade" id="Categorie" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div style="background-color: #025ea7;" class="modal-header">
                            <h5 class="modal-title" style="color: white;">Nouvelle Categorie</h5>
                            
                          </div>
                          <form action="/AjouterCategorie" method="post">
                            <div class="modal-body">
                              <label for="">Nom</label>
                              <input style="margin-top: 20px;" class="form-control" type="text" name="nom" placeholder="Nom de la nouvelle Categorie">
                            </div>
                  ...
                  <div class="col-5">
                    <form action="/RechercheCategorie" method="post">
                      <div class="row">
                        <%
                    ...
                    <tbody>
                      ...
                      <div class="modal fade" id="haha<%= s.getId()%>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            <div style="background-color: #025ea7;" class="modal-header">
                              <h5 class="modal-title" style="color: white;">Modification de la Categorie numero <%=s.getId() %></h5>
                            </div>
                      ...
                      <td><a href="/societe?id=<%= s.getId() %>"><button style="background-color: #025ea7;" type="button" class="btn btn-primary">Societe<i class="ri-edit-2-fill"></i></button></a></td>                     
                      <td><a href="/marque?id=<%= s.getId() %>&nomCategorie=<%= s.getNom() %>"><button style="background-color: #025ea7;" type="button" class="btn btn-primary">Marque<i class="ri-edit-2-fill"></i></button></a></td>                     
                      ...
                      <div class="modal fade" id="desactiver<%=s.getId() %>" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                           ...
                           <form action="/DesactiveCategorie" method="get">
                            <div class="modal-body">
                    ...
                    <div class="modal fade" id="act<%=s.getId() %>" tabindex="-1">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                         ...
                         <form action="/ActiveCategorie" method="get">
                          <div class="modal-body">
