    ...
    <div style="margin-left: 100px;" class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item ">Liste de produits</li> 
              ...
              <div class="card top-selling overflow-auto">
                ...
                <div style="min-height: 600px; max-height: 600px;" class="card-body pb-0">
                            ...
                            <th>
                              <form action="/" method="get">
                                ...
                                <button type="submit" style="background-color: #025ea7;" class="btn btn-primary">
                                  <i style="color: aliceblue;" class="bx bx-line-chart"></i>
                                  </button>
                              </form> 
                          </th>
                  ...
                  <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                    <ul class="pagination">
                      ...
                      <li class="page-item active" aria-current="page">
                        <a style="background-color: #025ea7;" class="page-link" href="/resultatproduitDn?page1=<%=current1-1%>"><%=current1%></a>
                      </li>
                    ...
                    %>
                    <li class="page-item"><a class="page-link" href="/resultatproduitDn?page1=<%=current1%>"><%=current1+1%></a></li>
                    <li class="page-item disabled"><a class="page-link" href="/resultatproduitDn?page1=<%=current1+1%>" aria-disabled="true"><%=current1+2%></a></li>
                    <li class="page-item">
                      <a class="page-link" href="/resultatproduitDn?page1=<%=next1%>">Suivant</a>
                    </li>
                    <%} else {%>

                      <li class="page-item"><a class="page-link" href="/resultatproduitDn?page1=<%=current1%>"><%=current1+1%></a></li>
                      <li class="page-item"><a class="page-link" href="/resultatproduitDn?page1=<%=current1+1%>"><%=current1+2%></a></li>
                      <li class="page-item">
                        <a class="page-link" href="/resultatproduitDn?page1=<%=next1%>">Suivant</a>
                      </li>
                  ...
                  <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                    <ul class="pagination">
                      <li class="page-item ">
                        <a class="page-link" href="/resultatproduitDn?page1=<%=previous1%>" tabindex="-1" >Precedent</a>
                      </li>
                    
                     
                      <li class="page-item"><a class="page-link" href="/resultatproduitDn?page1=<%=current1-2%>"><%=current1-1%></a></li>
  
                      <li class="page-item active" aria-current="page">
                        <a style="background-color: #025ea7;" class="page-link" href="/resultatproduitDn?page1=<%=current1-1%>"><%=current1%></a>
                      </li>

                      <li class="page-item disabled"><a class="page-link" href="/resultatproduitDn?page1=<%=current1%>" aria-disabled="true"><%=current1+1%></a></li>
                ...
                <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                  <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="/resultatproduitDn?page1=<%=current1-3%>"><%=current1-2%></a></li>
                ...
                <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                  <ul class="pagination">
                    ...
                    <li class="page-item disabled"><a class="page-link" href="/resultatproduitDn?page1=<%=current1%>" aria-disabled="true"><%=current1+1%></a></li>
                    <li class="page-item disabled">
                      <a class="page-link" href="/resultatproduitDn?page1=<%=next1%>" aria-disabled="true">Suivant</a>
                    </li>
                    <%
                      }else{
                    %>
