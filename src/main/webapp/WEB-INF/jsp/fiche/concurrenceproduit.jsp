              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="/concurrence_produit">DN</a></li>
                    <li><a class="dropdown-item" href="/concurrence_prix">Prix</a></li>
                    <li><a class="dropdown-item" href="/concurrence_rotation">Rotation</a></li>
                  </ul>
                </div>
                ...
                <div class="card-body pb-0">
                  ...
                  <h5 class="card-title">Concurence  <%=session.getAttribute("enquete")%></h5>
