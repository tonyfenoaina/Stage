            ...
            <div class="col-9">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <div class="col-5">
                    <form action="/RechercheMarqueEvolution" method="post">
                      <div class="row">
                        <%
                  ...
                  <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                    <ul class="pagination">
                      ...
                      <li class="page-item active" aria-current="page">
                        <a style="background-color: #025ea7;" class="page-link" href="/marque_list?page=<%=current-1%>"><%=current%></a>
                      </li>
                    ...
                    %>
                    <li class="page-item"><a class="page-link" href="/marque_list?page=<%=current%>"><%=current+1%></a></li>
                    <li class="page-item disabled"><a class="page-link" href="/marque_list?page=<%=current+1%>" aria-disabled="true"><%=current+2%></a></li>
                    <li class="page-item">
                      <a class="page-link" href="/marque_list?page=<%=next%>">Suivant</a>
                    </li>
                    <%} else {%>

                      <li class="page-item"><a class="page-link" href="/marque_list?page=<%=current%>"><%=current+1%></a></li>
                      <li class="page-item"><a class="page-link" href="/marque_list?page=<%=current+1%>"><%=current+2%></a></li>
                      <li class="page-item">
                        <a class="page-link" href="/marque_list?page=<%=next%>">Next</a>
                      </li>
                  ...
                  <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                    <ul class="pagination">
                      <li class="page-item ">
                        <a class="page-link" href="/marque_list?page=<%=previous%>" tabindex="-1" >Precedent</a>
                      </li>
                    
                     
                      <li class="page-item"><a class="page-link" href="/marque_list?page=<%=current-2%>"><%=current-1%></a></li>
  
                      <li class="page-item active" aria-current="page">
                        <a style="background-color: #025ea7;" class="page-link" href="/marque_list?page=<%=current-1%>"><%=current%></a>
                      </li>

                      <li class="page-item disabled"><a class="page-link" href="/marque_list?page=<%=current%>" aria-disabled="true"><%=current+1%></a></li>
                ...
                <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                  <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="/marque_list?page=<%=current-3%>"><%=current-2%></a></li>
                ...
                <nav style="margin-left: 20px;margin-top: 30px;" aria-label="...">
                  <ul class="pagination">
                    ...
                    <li class="page-item disabled"><a class="page-link" href="/marque_list?page=<%=current%>" aria-disabled="true"><%=current+1%></a></li>
                    <li class="page-item disabled">
                      <a class="page-link" href="/marque_list?page=<%=next%>" aria-disabled="true">Suivant</a>
                    </li>
                    <%
                      }else{
                    %>
